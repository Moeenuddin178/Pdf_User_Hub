...
import com.booksHub.example.pdf.activities.ViewerPdf;
...
//                try {
//                    Toast.makeText(mCtx, "hi"+wallpaperList.get(position).pdf.toString(), Toast.LENGTH_SHORT).show();
//                } catch (Exception e) {
//                    e.printStackTrace();
//                }
                Intent intent = new Intent(mCtx, ViewerPdf.class);

                intent.putExtra("link", wallpaperList.get(position).pdf);
